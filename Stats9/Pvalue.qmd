...
<div dir = "rtl", style = "color: black; font-size: 18px; font-family: Yas;">
تابع <bdi><b><span style = "font-family: courier new;">statsmodels.stats.multitest.fdrcorrection</span></b></bdi>&nbsp;  در حقیقت یک ابزار دیگر پایتون برای پیاده‌سازی همان  دو روش قبلی <br> <code>(BH, BY)</code>&nbsp; هست؛ این تابع 
