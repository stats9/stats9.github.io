...
<div dir = "rtl", style = "font-size: 18px; font-family: Yas">
لحاظ بشود، باید وقتی در <code>R</code> کد می‌نویسیم، از دستور 
</div>
...
<ul>
<li>
<b><code>Type I</code>:</b>&nbsp; این شیوه با لحاظ کردن ترتیب ورود عامل‌ها به مدل از بقیه مدل‌ها متمایز می‌شود، این روش برای طرح‌های نامتعادل توصیه نمی‌شود و همچنین برای طرح‌‌هایی که تعداد عامل‌های زیادی دارند هم توصیه نمی‌شود. ولی برای طرح‌های متعادل با تعداد عامل‌های پایین و همچنین مدل‌های <b><code>Nested-Design</code></b>&nbsp; می‌تواند مناسب باشد. و همچنین برای مدل‌های رگرسیون چند‌جمله‌ای هم مفید هست. 
</li>
<li>
